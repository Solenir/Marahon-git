 ...
 * @author solenir
 */
class ClientOperatorThread extends Thread {
    private Socket socket;
    private ObjectInputStream receive;
    private ObjectOutputStream send;
    private int portRequestClient;
    private int portRequestServer;
    private int dataReceived;
    
    

    public ClientOperatorThread(int portRequestClient, int portRequestServer) {
        this.portRequestClient = portRequestClient;
        this.portRequestServer = portRequestServer;
    }
    @Override
    public void run() {
        ...
        try {
            ...
            send.writeObject(portRequestClient);
            
            dataReceived = (int) receive.readObject();
           
            new Thread(new ServerOperatorThread(portRequestClient, portRequestServer, dataReceived)).start();
            /*
